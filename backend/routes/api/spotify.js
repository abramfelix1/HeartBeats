...
const redirect_uri = "http://localhost:3000/"; //Change to Render site when deploying or make if statement for production later
...
router.get("/login", (req, res) => {
  ...
  const state = req.cookies["_csrfToken"];
